package com.pablomonteserin.comparacion;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Persona palafabetico = servicios.getPrimerNombre(mapa);
			System.out.println("La persona que alfabeticamente va antes es : " +palafabetico.getNombre());
